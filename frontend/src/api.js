...
export const api = {
  ...
  meenzy: {
    ...
    batchAgentProcess: (availableInventory, unavailableItemsWithReplacements) => req('/meenzy/batch-agent/process', { method: 'POST', body: JSON.stringify({ availableInventory, unavailableItemsWithReplacements }) }),
