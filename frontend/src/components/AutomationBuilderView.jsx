  ...
  if (node.type === "message") {
    ...
    const TRIGGER_EXPLAIN = {
      ...
      qr: {
        ...
        source: "wa", sourceLabel: "WhatsApp inbound message webhook",
        title: "QR code scan",
        body: "Technically identical to a click-to-chat link — the QR encodes a wa.me URL with a pre-filled message that identifies the scan source. WhatsApp doesn't know it came from a QR; Meenzy Admin Portal attributes it via the pre-filled text."
      },
      newContact: {
