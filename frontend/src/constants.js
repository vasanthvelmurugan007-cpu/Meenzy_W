...
export const C = {
  pageBg: 'var(--c-pageBg, #F4F6F8)',
  sidebarBg: 'var(--c-sidebarBg, #FFFFFF)',
  sidebarBorder: 'var(--c-sidebarBorder, #E2E8F0)',
  headerBg: 'var(--c-headerBg, #ffffff)',
  headerText: 'var(--c-headerText, #0F172A)',
  headerMuted: 'var(--c-headerMuted, #64748B)',
  headerBorder: 'var(--c-headerBorder, #E2E8F0)',
  headerSurface: 'var(--c-headerSurface, #F1F5F9)',
  cardBg: 'var(--c-cardBg, #ffffff)',
  border: 'var(--c-border, #E2E8F0)',
  borderDark: 'var(--c-borderDark, #CBD5E1)',
  text: 'var(--c-text, #1E293B)',
  textSecondary: 'var(--c-textSecondary, #64748B)',
  textMuted: 'var(--c-textMuted, #94A3B8)',
  primary: 'var(--c-primary, #FF4757)',
  primaryHover: 'var(--c-primaryHover, #FF6B81)',
  primaryLight: 'var(--c-primaryLight, #FFEAEB)',
  primaryText: 'var(--c-primaryText, #FFFFFF)',
  purple: 'var(--c-purple, #8B5CF6)',
  green: 'var(--c-green, #10B981)',
  amber: 'var(--c-amber, #F59E0B)',
  aqua: 'var(--c-aqua, #0EB6CE)',
  shadowSm: 'var(--c-shadowSm, 0 1px 3px rgba(0,0,0,.04))',
  shadowMd: 'var(--c-shadowMd, 0 4px 12px rgba(0,0,0,.06))',
  shadowLg: 'var(--c-shadowLg, 0 12px 30px rgba(0,0,0,.08))',
  waBg: 'var(--c-waBg, #e5ddd5)',
  // neutral surface aliases
  surface: 'var(--c-surface, #ffffff)',
  surfaceAlt: 'var(--c-surfaceAlt, #F8FAFC)',
