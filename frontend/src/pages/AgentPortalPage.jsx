            ...
            {selectedOrder && (
              <div style={{ position: 'absolute', bottom: 20, left: 20, right: 20, background: theme.cardBg, borderRadius: 16, padding: 16, zIndex: 20, boxShadow: '0 10px 25px rgba(0,0,0,0.2)', border: `1px solid ${theme.border}` }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 12 }}>
                  <div>
                    <h4 style={{ margin: 0, fontSize: 16, fontWeight: 800, color: theme.text }}>Order #{selectedOrder.display_id || selectedOrder.wix_order_id || String(selectedOrder.id).split('-')[0].toUpperCase()}</h4>
              ...
              <div key={order.id} style={{ background: theme.cardBg, borderRadius: 16, padding: 20, boxShadow: '0 4px 6px rgba(0,0,0,0.05)', border: `1px solid ${theme.border}` }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 16 }}>
                  <div>
                    ...
                    <h3 style={{ margin: '8px 0 4px 0', fontSize: 18, color: theme.text, fontWeight: 800 }}>Order #{order.display_id || order.wix_order_id || String(order.id).split('-')[0].toUpperCase()}</h3>
