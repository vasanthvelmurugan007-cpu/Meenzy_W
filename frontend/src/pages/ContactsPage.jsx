...
export default function ContactsPage({ user }) {
  ...
  const selectedNumberName = (() => {
    const found = numbers.find(n => n.wa_number === selectedNumber);
    return (found?.display_name && found?.display_name !== selectedNumber) ? found.display_name : 'Meenzy';
  })();
            ...
            >
              ...
              {numbers.map(n => (
                <option key={n.wa_number} value={n.wa_number}>
                  {(n.display_name && n.display_name !== n.wa_number) ? n.display_name : 'Meenzy'} ({maskPhone(n.wa_number)})
                </option>
              ))}
            </select>
